...
<nav class="navbar navbar-expand-sm navbar-light bg-success p-3">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavId">
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a href="dashboard.php" class="text-light nav-link">Dushboad</a>
      </li>
      <li class="nav-item">
        <a href="disp_post.php" class="text-light nav-link">Posts</a>
      </li>
      <li class="nav-item">
        <a href="disp_category.php" class="text-light nav-link">Categories</a>
      </li>
      <li class="nav-item">
        <a href="disp_user.php" class="text-light nav-link">Users</a>
      </li>
    </ul>
    <ul class="navbar-nav">
      <li class="nav-item">
